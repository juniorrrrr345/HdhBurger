  ...
  const promoItems = [
    {
      ...
      description: "3 variétés au choix",
      price: "150€"
    },
    {
      name: "Pack Premium", 
      description: "5 variétés + bonus",
      price: "240€"
    },
    {
      name: "Pack VIP",
      description: "10 variétés + cadeaux", 
      price: "450€"
    },
    {
      name: "Pack Ultimate",
      description: "Toutes variétés + extras",
      price: "800€"
    }
  ];
      ...
      <div className="px-5 max-w-md mx-auto">
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-500 rounded-2xl p-5 mx-5 text-center shadow-xl">
          ...
          <p className="text-sm opacity-90 mb-1">
            -20% sur tous les packs avec le code HASHTAG20
          </p>
