          ...
          <div className="space-y-4 text-sm">
            ...
            <div className="border-l-4 border-red-600 pl-4">
              ...
              <p className="text-gray-300">
                Fournir des extractions de la plus haute qualité avec un service 
                client irréprochable et une discrétion totale.
              </p>
            </div>
          ...
          <div className="space-y-4">
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <p className="text-sm text-gray-300">
                Whole Melt et autres concentrés premium importés directement.
              </p>
            </div>
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <p className="text-sm text-gray-300">
                Livraison sous 24h dans toute la région Nord-Pas-de-Calais.
              </p>
            </div>
            
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              <h4 className="font-semibold text-white mb-2">🎁 Packs Promo</h4>
              <p className="text-sm text-gray-300">
                Offres spéciales et réductions pour nos clients fidèles.
              </p>
            </div>
          </div>
        </div>
